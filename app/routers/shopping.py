...
async def add_item_to_shopping_list(
    ...
    return await shopping_service.add_item_into_cart(request=request, user_id=current_user.id)
...
async def get_my_shopping_list(
    ...
    return await shopping_service.get_all_items(user_id=current_user.id)
...
async def toggle_shopping_item(
    ...
    return await shopping_service.toggle_item_status(item_id=item_id, user_id = current_user.id)